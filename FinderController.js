...
// =============================================================================
  ...
  findCtrl.keyword = ""
  findCtrl.gender = "4"             //1 = male, 2 = female, 3 = trans, 4 = don't care
...
// =============================================================================
  findCtrl.modalFiller = function(person){
    ...
    findCtrl.modalContent.gender = findCtrl.personArray[index].gender
...
// smokes - boolean,
// gender - string of male or female or trans,
// =============================================================================
  findCtrl.Person = function(firstName,lastName,phone,email,about,priceMin,priceMax,availability,age,smokes,image,gender){
...
// GENDER FILTER
  findCtrl.genderFilter = function(person){
    if (findCtrl.gender == "1" && person.gender == "male") {
      return true
    }
    else if (findCtrl.gender == "2" && person.gender == "female") {
      return true
    }
    else if (findCtrl.gender == "3" && person.gender == "trans") {
      return true
    }
    else if (findCtrl.gender == "4") {
      return true
    }
    else {
      return false
